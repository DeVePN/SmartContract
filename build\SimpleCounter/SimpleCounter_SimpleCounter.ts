...
export function loadTupleSimpleCounter$Data(source: TupleReader) {
    const _id = source.readBigNumber();
    const _counter = source.readBigNumber();
    return { $$type: 'SimpleCounter$Data' as const, id: _id, counter: _counter };
}

export function loadGetterTupleSimpleCounter$Data(source: TupleReader) {
    const _id = source.readBigNumber();
    const _counter = source.readBigNumber();
    return { $$type: 'SimpleCounter$Data' as const, id: _id, counter: _counter };
}

export function storeTupleSimpleCounter$Data(source: SimpleCounter$Data) {
    const builder = new TupleBuilder();
...
export function dictValueParserSimpleCounter$Data(): DictionaryValue<SimpleCounter$Data> {
    return {
        serialize: (src, builder) => {
...
async function SimpleCounter_init(id: bigint, counter: bigint) {
    ...
    initSimpleCounter_init_args({ $$type: 'SimpleCounter_init_args', id, counter })(builder);
...
export class SimpleCounter implements Contract {
    ...
    static async init(id: bigint, counter: bigint) {
        return await SimpleCounter_init(id, counter);
    }
    
    static async fromInit(id: bigint, counter: bigint) {
        const __gen_init = await SimpleCounter_init(id, counter);
